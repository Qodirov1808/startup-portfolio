...
<div class="card card-custom p-20">
	<div class="card-header">
        <h3 class="card-title">
            <span class="card-label font-weight-bolder text-dark">{{__('words.create button')}}</span>
        </h3>
	...
	<!--begin::Form-->
	<form action="{{route('langButton.store')}}" method="post" enctype="multipart/form-data" class="form">
        @csrf
		<div class="card-body">
			...
			<div class="form-group">
				...
				<input type="text" name="button_name_uz" id="button_name" class="form-control form-control-solid" placeholder="{{__('words.button name')}}_uz"/>
			</div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="button_name_en" id="button_name" class="form-control form-control-solid" placeholder="{{__('words.button name')}}_en"/>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="button_name_ru" id="button_name" class="form-control form-control-solid" placeholder="{{__('words.button name')}}_ru"/>
            </div>
