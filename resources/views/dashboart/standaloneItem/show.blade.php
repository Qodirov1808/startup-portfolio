                ...
                <table class="table table-borderless table-vertical-center">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td style="width: 100px" >
                                <span >{{ $standaloneItem->text['text_uz'] }}</span>
                            </td>
                            <td style="width: 200px">
                                <span>{{ $standaloneItem->text['text_en'] }}</span>
                            </td>
                            <td style="width: 200px">
                                <span>{{ $standaloneItem->text['text_ru'] }}</span>
                            </td>
                            <td style="width: 200px">
                                <span><img src="/storage/images/{{$standaloneItem->image}}" width="100px" alt="img"></span>
                            </td>
                            <td style="width: 200px">
                                <span>{{ $standaloneItem->description }}</span>
                            </td>
                        </tr>
                    </tbody>
                </table>
