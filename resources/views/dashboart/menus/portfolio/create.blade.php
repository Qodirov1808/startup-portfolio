...
<div class="card card-custom p-20">
	...
	<!--begin::Form-->
	<form action="{{route('portfolio.store')}}" method="post" enctype="multipart/form-data" class="form">
        @csrf
		<div class="card-body">
            ...
            <div class="form-group">
                ...
                <input type="text" name="data_title" class="form-control form-control-solid" placeholder="{{__('words.data title')}}"/>
            </div>
            @error('data_title')
            <div class="alert alert-danger">{{$message}}</div>
            @enderror
