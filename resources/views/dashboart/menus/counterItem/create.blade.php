...
<div class="card card-custom p-20">
	...
	<!--begin::Form-->
	<form action="{{route('counterItem.store')}}" method="post" enctype="multipart/form-data" class="form">
        @csrf
		<div class="card-body">
            ...
            <div class="form-group">
                ...
                <input type="text" name="count" class="form-control form-control-solid" placeholder="{{__('words.count')}}"/>
            </div>
            @error('count')
            <div class="alert alert-danger">{{$message}}</div>
            @enderror
            <div class="form-group">
                ...
                <input type="text" name="icon" class="form-control form-control-solid" placeholder="{{__('words.icon')}}"/>
            </div>
            @error('icon')
            <div class="alert alert-danger">{{$message}}</div>
            @enderror
