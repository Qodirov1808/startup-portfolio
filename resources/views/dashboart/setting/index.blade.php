    ...
    <div class="card card-custom card-stretch gutter-b">
        ...
        <div class="card-header border-0 pt-5">
            <h3 class="card-title align-items-start flex-column">
                <span class="card-label font-weight-bolder text-dark"> Social_media</span>
            </h3>
            <div class="card-toolbar">
                <ul class="nav nav-pills nav-pills-sm nav-dark-75">
                    <li class="nav-item">
                        <a class="btn btn-success" href="{{route('setting.create')}}">{{__('words.add new')}}</a>
                    </li>
                </ul>
            </div>
        </div>
                ...
                <table class="table table-borderless table-vertical-center">
                    <thead>
                        <tr>
                            ...
                            <th class="p-0" style="min-width: 125px">Logo</th>
                        </tr>
                    </thead>
                    <tbody>
                    @foreach ($settings as $setting)
                        <tr>
                            ...
                            <td >
                                <img width="100px" src="/storage/images/{{ $setting->logo1}}" alt="">
                            </td>
